...
public class CartController {
	...
	@GetMapping("/addItem/{cartId}")
	public boolean addItem(@PathVariable("cartId") int cartId) {
		return cartService.addItem(cartId);
	}
	
	@DeleteMapping("/removeItem/{cartId}")
	public boolean removeItem(@PathVariable("cartId") int cartId) {
